#!/usr/bin/env python3
# ==============================================================================================
# Original pipeline, copied without changes
# ==============================================================================================
# Everything below this header is a byte-for-byte copy of the production pipeline that the case
# study migrates. Do not edit it.
#
#     source:  ~/lakehouse-stack/scripts/pipelines/pipeline_spark41.py
#     commit:  7a0767a
#     copied:  2026-09-09
#     lines:   357
#     here:    lines 22 to 378 of this file, below a 21-line header
#
# The pipeline was copied rather than edited in place, so the original keeps running unchanged,
# and rolling back the migration means continuing to run it.
#
# It runs on Spark Classic only, because it calls spark.sparkContext, which Spark Connect does not
# provide. pipeline_after.py is the migrated version, README.md describes each change, and
