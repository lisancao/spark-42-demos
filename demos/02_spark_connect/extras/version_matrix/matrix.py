...
Results are written to extras/version_matrix/results/<cell>-run<N>.json. The method is described in
VERIFIED_FACTS.md §8. The operations are a sample, not a compatibility matrix.
"""
import argparse
import json
import sys
